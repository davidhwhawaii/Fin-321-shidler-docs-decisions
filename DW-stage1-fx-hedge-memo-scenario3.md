...
- **Stage 4 – Recommendation:** Select a strategy using model results, structure an AI-assisted prompt for hedge advisory support, and present a final executive briefing.
